...
2.  **Name Normalisation**: Class directory names and image filenames were converted to lowercase to ensure consistency across different operating systems and to prevent case-related errors.
