...
with gr.Blocks(theme=gr.themes.Glass(), title="Bird Classification Toolkit") as demo:
    gr.Markdown(
        """
        # 🐦 Bird Species Classification Toolkit
        A one-stop Gradio application for classifying bird images and managing the entire dataset preparation pipeline.
        """
    )
